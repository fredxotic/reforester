...
const Login = ({ onSwitchToRegister, onClose }) => {
  ...
  return (
    <div className="max-w-md w-full mx-auto">
      ...
      {/* Error Display */}
      {displayError && !displayError.includes('Verification email sent') && !showResendVerification && (
      ...
      {displayError && displayError.includes('Verification email sent') && (
